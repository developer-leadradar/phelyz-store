        ...
        <div class="w-full lg:w-80 flex-shrink-0">
          <div class="card p-6 lg:sticky lg:top-24">
            ...
            <div class="mt-5 pt-5 border-t border-stone-100 space-y-2">
              ...
              <div class="flex items-center gap-2 text-xs text-stone-500">
                <svg viewBox="0 0 20 20" fill="currentColor" width="14" height="14" class="text-gold flex-shrink-0"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd"/></svg>
