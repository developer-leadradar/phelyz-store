...
<a href="https://wa.me/<?php echo preg_replace('/\D/','',$_ENV['SITE_WHATSAPP']??SITE_WHATSAPP); ?>?text=Hello%20Phelyz%20Store,%20I%20need%20help"
  ...
  <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" width="30" height="30" aria-hidden="true">
    <!-- White speech bubble with curl -->
    <path fill="#FFFFFF" d="M3.4 28.6l1.85-6.74A12.45 12.45 0 0 1 3.59 15.6C3.59 8.71 9.2 3.1 16.09 3.1a12.4 12.4 0 0 1 8.83 3.67 12.4 12.4 0 0 1 3.66 8.83c0 6.89-5.61 12.5-12.49 12.5h-.01a12.5 12.5 0 0 1-5.97-1.52L3.4 28.6z"/>
    <!-- Green handset inside speech bubble -->
    <path fill="#25D366" fill-rule="evenodd" clip-rule="evenodd" d="M12.84 10.4c-.23-.52-.48-.53-.7-.54l-.59-.01c-.21 0-.54.08-.83.39-.29.31-1.09 1.07-1.09 2.6 0 1.54 1.12 3.02 1.27 3.23.16.21 2.18 3.34 5.32 4.69.74.32 1.32.51 1.78.65.75.24 1.43.2 1.97.12.6-.09 1.85-.76 2.11-1.49.26-.73.26-1.36.19-1.49-.08-.13-.29-.21-.6-.37-.31-.16-1.85-.91-2.14-1.02-.29-.1-.5-.16-.7.16-.21.31-.81 1.02-1 1.23-.18.21-.36.23-.67.08-.31-.16-1.32-.49-2.52-1.55-.93-.83-1.56-1.85-1.75-2.17-.18-.31-.02-.48.14-.64.14-.14.31-.36.47-.55.16-.18.21-.31.31-.52.1-.21.05-.39-.03-.55-.08-.16-.7-1.7-.96-2.32z"/>
  </svg>
</a>
  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div>
        <div class="footer-logo">
          <img src="<?php echo SITE_URL; ?>/assets/images/phelyz-logo-light.svg"
               alt="<?php echo htmlspecialchars(SITE_NAME); ?>" class="footer-logo-img">
        </div>
      ...
      <div class="footer-col">
        ...
        <div class="footer-contact-row">
          ...
          <a href="tel:<?php echo preg_replace('/\s+/','',SITE_PHONE); ?>"><?php echo SITE_PHONE; ?></a>
        </div>
        <div class="footer-contact-row">
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-bottom-links">
        <a href="<?php echo SITE_URL; ?>/terms.php#privacy">Privacy Policy</a>
        <a href="<?php echo SITE_URL; ?>/terms.php">Terms &amp; Conditions</a>
        <a href="<?php echo SITE_URL; ?>/track.php">Track Order</a>
      ...
      <div class="payment-tags" style="display:flex;align-items:center;gap:6px">
        ...
        <span class="payment-tag">Transfer</span>
