      ...
      <?php foreach ($featuredProducts as $p): ?>
        <div class="product-card" onclick="window.location='product.php?id=<?php echo $p['id']; ?>'">
          <div class="product-card-img">
            ...
            <?php endif; ?>
            <?php $idxEff = effectiveStockStatus($p); ?>
            <?php if ($idxEff === 'express'): ?>
            ...
            <div class="product-card-actions">
              ...
              <?php if (isLoggedIn()): ?>
              <button onclick="event.stopPropagation();addToWishlist(<?php echo $p['id']; ?>, this)" class="icon-btn" title="Add to Wishlist">
          ...
          <div class="product-card-body">
            ...
            <?php $idxEff = effectiveStockStatus($p); ?>
            <?php if ($idxEff === 'preorder' || $idxEff === 'express'): ?>
